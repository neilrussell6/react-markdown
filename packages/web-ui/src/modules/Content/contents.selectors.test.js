...
describe('modules/Content/contents.selector', () => {
  ...
  describe('selectedContentSelector', () => {
    it('should select selected content markdown as expected', () => {
      ...
      // when ... we select selected content
      // then ... should return content 2
      const result = SUT.selectedContentSelector(state)
      expect(result).toMatchObject(state.contents[2])
    })
  })
})
