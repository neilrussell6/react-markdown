...
export const apiGetContentsSuccess = (data) => ({
  type: API_GET_CONTENTS_SUCCESS,
  payload: data,
})
export const apiGetContentsFailure = (message) => ({
  type: API_GET_CONTENTS_FAILURE,
  payload: { message },
})
...
export const apiGetContentSuccess = (data) => ({
  type: API_GET_CONTENT_SUCCESS,
  payload: data,
})
export const apiGetContentFailure = (message) => ({
  type: API_GET_CONTENT_FAILURE,
  payload: { message },
})
...
const overwriteContents = (state, { payload }) => {
  ...
  return isNil(contents) ? null : normalize('id')(contents)
}

const updateContents = (state, { payload: content }) => {
  const { id, markdownContent } = content
  return assocPath([id, 'markdownContent'], markdownContent)(state)
}
